...
//
// The extension kind metadata
// swagger:model extension_metadata
type ExtensionMetadata struct {

	// account reference
	AccountReference *AccountReference `json:"account_reference,omitempty"`

	// Categories for the extension
	Categories map[string]string `json:"categories,omitempty"`

	// Time when extension was created
	...
	// Time when extension was last updated
...
func (m *ExtensionMetadata) validateAccountReference(formats strfmt.Registry) error {
...
func (m *ExtensionMetadata) validateCategories(formats strfmt.Registry) error {
...
var extensionMetadataTypeKindPropEnum []interface{}

const (
	extensionMetadataKindExtension string = "extension"
)

// prop value enum
func (m *ExtensionMetadata) validateKindEnum(path, location string, value string) error {
	if extensionMetadataTypeKindPropEnum == nil {
		var res []string
		if err := json.Unmarshal([]byte(`["extension"]`), &res); err != nil {
			return err
		}
		for _, v := range res {
			extensionMetadataTypeKindPropEnum = append(extensionMetadataTypeKindPropEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, extensionMetadataTypeKindPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *ExtensionMetadata) validateKind(formats strfmt.Registry) error {
...
func (m *ExtensionMetadata) validateName(formats strfmt.Registry) error {
...
func (m *ExtensionMetadata) validateOwnerReference(formats strfmt.Registry) error {
...
func (m *ExtensionMetadata) validateParentReference(formats strfmt.Registry) error {
...
func (m *ExtensionMetadata) validateUUID(formats strfmt.Registry) error {
