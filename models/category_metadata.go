...
//
// The category kind metadata
// swagger:model category_metadata
type CategoryMetadata struct {
	...
	// Time when category was last updated
...
// Validate validates this category metadata
func (m *CategoryMetadata) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CategoryMetadata) validateAccountReference(formats strfmt.Registry) error {
...
func (m *CategoryMetadata) validateCategories(formats strfmt.Registry) error {
...
var categoryMetadataTypeKindPropEnum []interface{}

const (
	categoryMetadataKindCategory string = "category"
)

// prop value enum
func (m *CategoryMetadata) validateKindEnum(path, location string, value string) error {
	if categoryMetadataTypeKindPropEnum == nil {
		var res []string
		if err := json.Unmarshal([]byte(`["category"]`), &res); err != nil {
			return err
		}
		for _, v := range res {
			categoryMetadataTypeKindPropEnum = append(categoryMetadataTypeKindPropEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, categoryMetadataTypeKindPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *CategoryMetadata) validateKind(formats strfmt.Registry) error {
...
func (m *CategoryMetadata) validateName(formats strfmt.Registry) error {
...
func (m *CategoryMetadata) validateOwnerReference(formats strfmt.Registry) error {
...
func (m *CategoryMetadata) validateParentReference(formats strfmt.Registry) error {
...
func (m *CategoryMetadata) validateUUID(formats strfmt.Registry) error {
