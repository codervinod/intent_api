...
// VolumeGroupMetadata volume_group metadata
//
// The volume_group kind metadata
// swagger:model volume_group_metadata
type VolumeGroupMetadata struct {

	// account reference
	AccountReference *AccountReference `json:"account_reference,omitempty"`

	// Categories for the volume_group
	Categories map[string]string `json:"categories,omitempty"`

	// Time when volume_group was created
	...
	// Time when volume_group was last updated
...
// Validate validates this volume group metadata
func (m *VolumeGroupMetadata) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *VolumeGroupMetadata) validateAccountReference(formats strfmt.Registry) error {
...
func (m *VolumeGroupMetadata) validateCategories(formats strfmt.Registry) error {
...
var volumeGroupMetadataTypeKindPropEnum []interface{}

const (
	volumeGroupMetadataKindVolumeGroup string = "volume_group"
)

// prop value enum
func (m *VolumeGroupMetadata) validateKindEnum(path, location string, value string) error {
	if volumeGroupMetadataTypeKindPropEnum == nil {
		var res []string
		if err := json.Unmarshal([]byte(`["volume_group"]`), &res); err != nil {
			return err
		}
		for _, v := range res {
			volumeGroupMetadataTypeKindPropEnum = append(volumeGroupMetadataTypeKindPropEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, volumeGroupMetadataTypeKindPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *VolumeGroupMetadata) validateKind(formats strfmt.Registry) error {
...
func (m *VolumeGroupMetadata) validateName(formats strfmt.Registry) error {
...
func (m *VolumeGroupMetadata) validateOwnerReference(formats strfmt.Registry) error {
...
func (m *VolumeGroupMetadata) validateParentReference(formats strfmt.Registry) error {
...
func (m *VolumeGroupMetadata) validateUUID(formats strfmt.Registry) error {
