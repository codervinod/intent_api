...
// swagger:model account_metadata
...
// Validate validates this account metadata
func (m *AccountMetadata) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AccountMetadata) validateAccountReference(formats strfmt.Registry) error {
...
func (m *AccountMetadata) validateCategories(formats strfmt.Registry) error {
...
var accountMetadataTypeKindPropEnum []interface{}

const (
	accountMetadataKindAccount string = "account"
)

// prop value enum
func (m *AccountMetadata) validateKindEnum(path, location string, value string) error {
	if accountMetadataTypeKindPropEnum == nil {
		var res []string
		if err := json.Unmarshal([]byte(`["account"]`), &res); err != nil {
			return err
		}
		for _, v := range res {
			accountMetadataTypeKindPropEnum = append(accountMetadataTypeKindPropEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, accountMetadataTypeKindPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *AccountMetadata) validateKind(formats strfmt.Registry) error {
...
func (m *AccountMetadata) validateName(formats strfmt.Registry) error {
...
func (m *AccountMetadata) validateOwnerReference(formats strfmt.Registry) error {
...
func (m *AccountMetadata) validateParentReference(formats strfmt.Registry) error {
...
func (m *AccountMetadata) validateUUID(formats strfmt.Registry) error {
