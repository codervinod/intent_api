...
//
// The oauth kind metadata
// swagger:model oauth_metadata
type OauthMetadata struct {

	// account reference
	AccountReference *AccountReference `json:"account_reference,omitempty"`

	// Categories for the oauth
	Categories map[string]string `json:"categories,omitempty"`

	// Time when oauth was created
	...
	// Time when oauth was last updated
...
// Validate validates this oauth metadata
func (m *OauthMetadata) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OauthMetadata) validateAccountReference(formats strfmt.Registry) error {
...
func (m *OauthMetadata) validateCategories(formats strfmt.Registry) error {
...
var oauthMetadataTypeKindPropEnum []interface{}

const (
	oauthMetadataKindOauth string = "oauth"
)

// prop value enum
func (m *OauthMetadata) validateKindEnum(path, location string, value string) error {
	if oauthMetadataTypeKindPropEnum == nil {
		var res []string
		if err := json.Unmarshal([]byte(`["oauth"]`), &res); err != nil {
			return err
		}
		for _, v := range res {
			oauthMetadataTypeKindPropEnum = append(oauthMetadataTypeKindPropEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, oauthMetadataTypeKindPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *OauthMetadata) validateKind(formats strfmt.Registry) error {
...
func (m *OauthMetadata) validateName(formats strfmt.Registry) error {
...
func (m *OauthMetadata) validateOwnerReference(formats strfmt.Registry) error {
...
func (m *OauthMetadata) validateParentReference(formats strfmt.Registry) error {
...
func (m *OauthMetadata) validateUUID(formats strfmt.Registry) error {
