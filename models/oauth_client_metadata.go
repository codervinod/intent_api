...
// OauthClientMetadata oauth_client metadata
//
// The oauth_client kind metadata
// swagger:model oauth_client_metadata
type OauthClientMetadata struct {

	// account reference
	AccountReference *AccountReference `json:"account_reference,omitempty"`

	// Categories for the oauth_client
	Categories map[string]string `json:"categories,omitempty"`

	// Time when oauth_client was created
	...
	// Time when oauth_client was last updated
...
// Validate validates this oauth client metadata
func (m *OauthClientMetadata) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OauthClientMetadata) validateAccountReference(formats strfmt.Registry) error {
...
func (m *OauthClientMetadata) validateCategories(formats strfmt.Registry) error {
...
var oauthClientMetadataTypeKindPropEnum []interface{}

const (
	oauthClientMetadataKindOauthClient string = "oauth_client"
)

// prop value enum
func (m *OauthClientMetadata) validateKindEnum(path, location string, value string) error {
	if oauthClientMetadataTypeKindPropEnum == nil {
		var res []string
		if err := json.Unmarshal([]byte(`["oauth_client"]`), &res); err != nil {
			return err
		}
		for _, v := range res {
			oauthClientMetadataTypeKindPropEnum = append(oauthClientMetadataTypeKindPropEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, oauthClientMetadataTypeKindPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *OauthClientMetadata) validateKind(formats strfmt.Registry) error {
...
func (m *OauthClientMetadata) validateName(formats strfmt.Registry) error {
...
func (m *OauthClientMetadata) validateOwnerReference(formats strfmt.Registry) error {
...
func (m *OauthClientMetadata) validateParentReference(formats strfmt.Registry) error {
...
func (m *OauthClientMetadata) validateUUID(formats strfmt.Registry) error {
