...
// SoftwareMetadata software metadata
//
// The software kind metadata
// swagger:model software_metadata
type SoftwareMetadata struct {

	// account reference
	AccountReference *AccountReference `json:"account_reference,omitempty"`

	// Categories for the software
	Categories map[string]string `json:"categories,omitempty"`

	// Time when software was created
	...
	// Time when software was last updated
...
// Validate validates this software metadata
func (m *SoftwareMetadata) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SoftwareMetadata) validateAccountReference(formats strfmt.Registry) error {
...
func (m *SoftwareMetadata) validateCategories(formats strfmt.Registry) error {
...
var softwareMetadataTypeKindPropEnum []interface{}

const (
	softwareMetadataKindSoftware string = "software"
)

// prop value enum
func (m *SoftwareMetadata) validateKindEnum(path, location string, value string) error {
	if softwareMetadataTypeKindPropEnum == nil {
		var res []string
		if err := json.Unmarshal([]byte(`["software"]`), &res); err != nil {
			return err
		}
		for _, v := range res {
			softwareMetadataTypeKindPropEnum = append(softwareMetadataTypeKindPropEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, softwareMetadataTypeKindPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *SoftwareMetadata) validateKind(formats strfmt.Registry) error {
...
func (m *SoftwareMetadata) validateName(formats strfmt.Registry) error {
...
func (m *SoftwareMetadata) validateOwnerReference(formats strfmt.Registry) error {
...
func (m *SoftwareMetadata) validateParentReference(formats strfmt.Registry) error {
...
func (m *SoftwareMetadata) validateUUID(formats strfmt.Registry) error {
