...
// Extension Extension manifest information
//
...
func (m *Extension) validateDescription(formats strfmt.Registry) error {
...
func (m *Extension) validateResources(formats strfmt.Registry) error {
