...
//
// The container kind metadata
// swagger:model container_metadata
type ContainerMetadata struct {

	// account reference
	AccountReference *AccountReference `json:"account_reference,omitempty"`

	// Categories for the container
	...
	// Time when container was last updated
...
// Validate validates this container metadata
func (m *ContainerMetadata) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContainerMetadata) validateAccountReference(formats strfmt.Registry) error {
...
func (m *ContainerMetadata) validateCategories(formats strfmt.Registry) error {
...
var containerMetadataTypeKindPropEnum []interface{}

const (
	containerMetadataKindContainer string = "container"
)

// prop value enum
func (m *ContainerMetadata) validateKindEnum(path, location string, value string) error {
	if containerMetadataTypeKindPropEnum == nil {
		var res []string
		if err := json.Unmarshal([]byte(`["container"]`), &res); err != nil {
			return err
		}
		for _, v := range res {
			containerMetadataTypeKindPropEnum = append(containerMetadataTypeKindPropEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, containerMetadataTypeKindPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *ContainerMetadata) validateKind(formats strfmt.Registry) error {
...
func (m *ContainerMetadata) validateName(formats strfmt.Registry) error {
...
func (m *ContainerMetadata) validateOwnerReference(formats strfmt.Registry) error {
...
func (m *ContainerMetadata) validateParentReference(formats strfmt.Registry) error {
...
func (m *ContainerMetadata) validateUUID(formats strfmt.Registry) error {
