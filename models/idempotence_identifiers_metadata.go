...
type IdempotenceIdentifiersMetadata struct {
	...
	// Categories for the idempotence_identifiers
	Categories map[string]string `json:"categories,omitempty"`

	// Time when idempotence_identifiers was created
	...
	// Time when idempotence_identifiers was last updated
...
func (m *IdempotenceIdentifiersMetadata) validateAccountReference(formats strfmt.Registry) error {
...
func (m *IdempotenceIdentifiersMetadata) validateCategories(formats strfmt.Registry) error {
...
var idempotenceIdentifiersMetadataTypeKindPropEnum []interface{}

const (
	idempotenceIdentifiersMetadataKindIdempotenceIdentifiers string = "idempotence_identifiers"
)

// prop value enum
func (m *IdempotenceIdentifiersMetadata) validateKindEnum(path, location string, value string) error {
	if idempotenceIdentifiersMetadataTypeKindPropEnum == nil {
		var res []string
		if err := json.Unmarshal([]byte(`["idempotence_identifiers"]`), &res); err != nil {
			return err
		}
		for _, v := range res {
			idempotenceIdentifiersMetadataTypeKindPropEnum = append(idempotenceIdentifiersMetadataTypeKindPropEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, idempotenceIdentifiersMetadataTypeKindPropEnum); err != nil {
		return err
	}
	return nil
}
...
func (m *IdempotenceIdentifiersMetadata) validateParentReference(formats strfmt.Registry) error {
