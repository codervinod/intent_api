...
//
// The catalog kind metadata
// swagger:model catalog_metadata
type CatalogMetadata struct {
	...
	// Time when catalog was last updated
...
// Validate validates this catalog metadata
func (m *CatalogMetadata) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CatalogMetadata) validateAccountReference(formats strfmt.Registry) error {
...
func (m *CatalogMetadata) validateCategories(formats strfmt.Registry) error {
...
var catalogMetadataTypeKindPropEnum []interface{}

const (
	catalogMetadataKindCatalog string = "catalog"
)

// prop value enum
func (m *CatalogMetadata) validateKindEnum(path, location string, value string) error {
	if catalogMetadataTypeKindPropEnum == nil {
		var res []string
		if err := json.Unmarshal([]byte(`["catalog"]`), &res); err != nil {
			return err
		}
		for _, v := range res {
			catalogMetadataTypeKindPropEnum = append(catalogMetadataTypeKindPropEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, catalogMetadataTypeKindPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *CatalogMetadata) validateKind(formats strfmt.Registry) error {
...
func (m *CatalogMetadata) validateName(formats strfmt.Registry) error {
...
func (m *CatalogMetadata) validateOwnerReference(formats strfmt.Registry) error {
...
func (m *CatalogMetadata) validateParentReference(formats strfmt.Registry) error {
...
func (m *CatalogMetadata) validateUUID(formats strfmt.Registry) error {
