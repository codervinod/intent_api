...
type RoleMetadata struct {
	...
	// Time when role was last updated
...
// Validate validates this role metadata
func (m *RoleMetadata) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RoleMetadata) validateAccountReference(formats strfmt.Registry) error {
...
func (m *RoleMetadata) validateCategories(formats strfmt.Registry) error {
...
var roleMetadataTypeKindPropEnum []interface{}

const (
	roleMetadataKindRole string = "role"
)

// prop value enum
func (m *RoleMetadata) validateKindEnum(path, location string, value string) error {
	if roleMetadataTypeKindPropEnum == nil {
		var res []string
		if err := json.Unmarshal([]byte(`["role"]`), &res); err != nil {
			return err
		}
		for _, v := range res {
			roleMetadataTypeKindPropEnum = append(roleMetadataTypeKindPropEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, roleMetadataTypeKindPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *RoleMetadata) validateKind(formats strfmt.Registry) error {
...
func (m *RoleMetadata) validateName(formats strfmt.Registry) error {
...
func (m *RoleMetadata) validateOwnerReference(formats strfmt.Registry) error {
...
func (m *RoleMetadata) validateParentReference(formats strfmt.Registry) error {
...
func (m *RoleMetadata) validateUUID(formats strfmt.Registry) error {
