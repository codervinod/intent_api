...
// AvailabilityZoneMetadata availability_zone metadata
//
// The availability_zone kind metadata
// swagger:model availability_zone_metadata
type AvailabilityZoneMetadata struct {

	// account reference
	AccountReference *AccountReference `json:"account_reference,omitempty"`

	// Categories for the availability_zone
	Categories map[string]string `json:"categories,omitempty"`

	// Time when availability_zone was created
	...
	// Time when availability_zone was last updated
...
// Validate validates this availability zone metadata
func (m *AvailabilityZoneMetadata) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AvailabilityZoneMetadata) validateAccountReference(formats strfmt.Registry) error {
...
func (m *AvailabilityZoneMetadata) validateCategories(formats strfmt.Registry) error {
...
var availabilityZoneMetadataTypeKindPropEnum []interface{}

const (
	availabilityZoneMetadataKindAvailabilityZone string = "availability_zone"
)

// prop value enum
func (m *AvailabilityZoneMetadata) validateKindEnum(path, location string, value string) error {
	if availabilityZoneMetadataTypeKindPropEnum == nil {
		var res []string
		if err := json.Unmarshal([]byte(`["availability_zone"]`), &res); err != nil {
			return err
		}
		for _, v := range res {
			availabilityZoneMetadataTypeKindPropEnum = append(availabilityZoneMetadataTypeKindPropEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, availabilityZoneMetadataTypeKindPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *AvailabilityZoneMetadata) validateKind(formats strfmt.Registry) error {
...
func (m *AvailabilityZoneMetadata) validateName(formats strfmt.Registry) error {
...
func (m *AvailabilityZoneMetadata) validateOwnerReference(formats strfmt.Registry) error {
...
func (m *AvailabilityZoneMetadata) validateParentReference(formats strfmt.Registry) error {
...
func (m *AvailabilityZoneMetadata) validateUUID(formats strfmt.Registry) error {
