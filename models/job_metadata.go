...
//
// The job kind metadata
// swagger:model job_metadata
...
// Validate validates this job metadata
func (m *JobMetadata) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *JobMetadata) validateAccountReference(formats strfmt.Registry) error {
...
func (m *JobMetadata) validateCategories(formats strfmt.Registry) error {
...
var jobMetadataTypeKindPropEnum []interface{}

const (
	jobMetadataKindJob string = "job"
)

// prop value enum
func (m *JobMetadata) validateKindEnum(path, location string, value string) error {
	if jobMetadataTypeKindPropEnum == nil {
		var res []string
		if err := json.Unmarshal([]byte(`["job"]`), &res); err != nil {
			return err
		}
		for _, v := range res {
			jobMetadataTypeKindPropEnum = append(jobMetadataTypeKindPropEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, jobMetadataTypeKindPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *JobMetadata) validateKind(formats strfmt.Registry) error {
...
func (m *JobMetadata) validateName(formats strfmt.Registry) error {
...
func (m *JobMetadata) validateOwnerReference(formats strfmt.Registry) error {
...
func (m *JobMetadata) validateParentReference(formats strfmt.Registry) error {
...
func (m *JobMetadata) validateUUID(formats strfmt.Registry) error {
