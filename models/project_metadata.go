...
// swagger:model project_metadata
...
func (m *ProjectMetadata) validateAccountReference(formats strfmt.Registry) error {
...
func (m *ProjectMetadata) validateCategories(formats strfmt.Registry) error {
...
var projectMetadataTypeKindPropEnum []interface{}

const (
	projectMetadataKindProject string = "project"
)

// prop value enum
func (m *ProjectMetadata) validateKindEnum(path, location string, value string) error {
	if projectMetadataTypeKindPropEnum == nil {
		var res []string
		if err := json.Unmarshal([]byte(`["project"]`), &res); err != nil {
			return err
		}
		for _, v := range res {
			projectMetadataTypeKindPropEnum = append(projectMetadataTypeKindPropEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, projectMetadataTypeKindPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *ProjectMetadata) validateKind(formats strfmt.Registry) error {
...
func (m *ProjectMetadata) validateName(formats strfmt.Registry) error {
...
func (m *ProjectMetadata) validateOwnerReference(formats strfmt.Registry) error {
...
func (m *ProjectMetadata) validateParentReference(formats strfmt.Registry) error {
...
func (m *ProjectMetadata) validateUUID(formats strfmt.Registry) error {
