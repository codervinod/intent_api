...
// Validate validates this policy metadata
func (m *PolicyMetadata) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PolicyMetadata) validateAccountReference(formats strfmt.Registry) error {
...
func (m *PolicyMetadata) validateCategories(formats strfmt.Registry) error {
...
var policyMetadataTypeKindPropEnum []interface{}

const (
	policyMetadataKindPolicy string = "policy"
)

// prop value enum
func (m *PolicyMetadata) validateKindEnum(path, location string, value string) error {
	if policyMetadataTypeKindPropEnum == nil {
		var res []string
		if err := json.Unmarshal([]byte(`["policy"]`), &res); err != nil {
			return err
		}
		for _, v := range res {
			policyMetadataTypeKindPropEnum = append(policyMetadataTypeKindPropEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, policyMetadataTypeKindPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *PolicyMetadata) validateKind(formats strfmt.Registry) error {
...
func (m *PolicyMetadata) validateName(formats strfmt.Registry) error {
...
func (m *PolicyMetadata) validateOwnerReference(formats strfmt.Registry) error {
...
func (m *PolicyMetadata) validateParentReference(formats strfmt.Registry) error {
...
func (m *PolicyMetadata) validateUUID(formats strfmt.Registry) error {
