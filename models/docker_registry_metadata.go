...
// DockerRegistryMetadata docker_registry metadata
//
// The docker_registry kind metadata
// swagger:model docker_registry_metadata
type DockerRegistryMetadata struct {

	// account reference
	AccountReference *AccountReference `json:"account_reference,omitempty"`

	// Categories for the docker_registry
	Categories map[string]string `json:"categories,omitempty"`

	// Time when docker_registry was created
	...
	// Time when docker_registry was last updated
...
// Validate validates this docker registry metadata
func (m *DockerRegistryMetadata) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DockerRegistryMetadata) validateAccountReference(formats strfmt.Registry) error {
...
func (m *DockerRegistryMetadata) validateCategories(formats strfmt.Registry) error {
...
var dockerRegistryMetadataTypeKindPropEnum []interface{}

const (
	dockerRegistryMetadataKindDockerRegistry string = "docker_registry"
)

// prop value enum
func (m *DockerRegistryMetadata) validateKindEnum(path, location string, value string) error {
	if dockerRegistryMetadataTypeKindPropEnum == nil {
		var res []string
		if err := json.Unmarshal([]byte(`["docker_registry"]`), &res); err != nil {
			return err
		}
		for _, v := range res {
			dockerRegistryMetadataTypeKindPropEnum = append(dockerRegistryMetadataTypeKindPropEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, dockerRegistryMetadataTypeKindPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *DockerRegistryMetadata) validateKind(formats strfmt.Registry) error {
...
func (m *DockerRegistryMetadata) validateName(formats strfmt.Registry) error {
...
func (m *DockerRegistryMetadata) validateOwnerReference(formats strfmt.Registry) error {
...
func (m *DockerRegistryMetadata) validateParentReference(formats strfmt.Registry) error {
...
func (m *DockerRegistryMetadata) validateUUID(formats strfmt.Registry) error {
