...
// VolumeGroupSnapshot volume_group snapshot input definitions
//
// The input object that defines a volume_group snapshot
// swagger:model volume_group_snapshot
type VolumeGroupSnapshot struct {
	...
	// resources
	Resources *VolumeGroupSnapshotResources `json:"resources,omitempty"`

	// Crash consistent or Application Consistent snapshot
	SnapshotType string `json:"snapshot_type,omitempty"`
}

// Validate validates this volume group snapshot
func (m *VolumeGroupSnapshot) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *VolumeGroupSnapshot) validateClusterReference(formats strfmt.Registry) error {
...
func (m *VolumeGroupSnapshot) validateConsistencyGroupIdentifier(formats strfmt.Registry) error {
...
func (m *VolumeGroupSnapshot) validateEntityBackupReference(formats strfmt.Registry) error {
...
func (m *VolumeGroupSnapshot) validateLocationAgnosticIdentifier(formats strfmt.Registry) error {
...
func (m *VolumeGroupSnapshot) validateName(formats strfmt.Registry) error {
...
func (m *VolumeGroupSnapshot) validateResources(formats strfmt.Registry) error {
...
var volumeGroupSnapshotTypeSnapshotTypePropEnum []interface{}

const (
	volumeGroupSnapshotSnapshotTypeCRASHCONSISTENT       string = "CRASH_CONSISTENT"
	volumeGroupSnapshotSnapshotTypeAPPLICATIONCONSISTENT string = "APPLICATION_CONSISTENT"
)

// prop value enum
func (m *VolumeGroupSnapshot) validateSnapshotTypeEnum(path, location string, value string) error {
	if volumeGroupSnapshotTypeSnapshotTypePropEnum == nil {
		var res []string
		if err := json.Unmarshal([]byte(`["CRASH_CONSISTENT","APPLICATION_CONSISTENT"]`), &res); err != nil {
			return err
		}
		for _, v := range res {
			volumeGroupSnapshotTypeSnapshotTypePropEnum = append(volumeGroupSnapshotTypeSnapshotTypePropEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, volumeGroupSnapshotTypeSnapshotTypePropEnum); err != nil {
		return err
	}
	return nil
}

func (m *VolumeGroupSnapshot) validateSnapshotType(formats strfmt.Registry) error {
...
// VolumeGroupSnapshotResources Snapshot Resources
// swagger:model VolumeGroupSnapshotResources
...
// Validate validates this volume group snapshot resources
func (m *VolumeGroupSnapshotResources) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *VolumeGroupSnapshotResources) validateEntityUUID(formats strfmt.Registry) error {
