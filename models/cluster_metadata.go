...
// swagger:model cluster_metadata
type ClusterMetadata struct {

	// account reference
	AccountReference *AccountReference `json:"account_reference,omitempty"`

	// Categories for the cluster
	Categories map[string]string `json:"categories,omitempty"`

	// Time when cluster was created
	...
	// Time when cluster was last updated
...
func (m *ClusterMetadata) validateAccountReference(formats strfmt.Registry) error {
...
func (m *ClusterMetadata) validateCategories(formats strfmt.Registry) error {
...
var clusterMetadataTypeKindPropEnum []interface{}

const (
	clusterMetadataKindCluster string = "cluster"
)

// prop value enum
func (m *ClusterMetadata) validateKindEnum(path, location string, value string) error {
	if clusterMetadataTypeKindPropEnum == nil {
		var res []string
		if err := json.Unmarshal([]byte(`["cluster"]`), &res); err != nil {
			return err
		}
		for _, v := range res {
			clusterMetadataTypeKindPropEnum = append(clusterMetadataTypeKindPropEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, clusterMetadataTypeKindPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *ClusterMetadata) validateKind(formats strfmt.Registry) error {
...
func (m *ClusterMetadata) validateName(formats strfmt.Registry) error {
...
func (m *ClusterMetadata) validateOwnerReference(formats strfmt.Registry) error {
...
func (m *ClusterMetadata) validateParentReference(formats strfmt.Registry) error {
...
func (m *ClusterMetadata) validateUUID(formats strfmt.Registry) error {
