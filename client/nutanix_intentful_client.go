...
import (
	...
	"github.com/codervinod/intent_api/client/availability_zone"
	"github.com/codervinod/intent_api/client/batch"
	"github.com/codervinod/intent_api/client/catalogs"
	"github.com/codervinod/intent_api/client/category"
	"github.com/codervinod/intent_api/client/clusters"
	"github.com/codervinod/intent_api/client/containers"
	"github.com/codervinod/intent_api/client/data"
	"github.com/codervinod/intent_api/client/docker_registry"
	"github.com/codervinod/intent_api/client/extension"
	"github.com/codervinod/intent_api/client/groups"
	"github.com/codervinod/intent_api/client/hosts"
	"github.com/codervinod/intent_api/client/idempotence_identifiers"
	"github.com/codervinod/intent_api/client/images"
	"github.com/codervinod/intent_api/client/job"
	"github.com/codervinod/intent_api/client/network"
	"github.com/codervinod/intent_api/client/oauth"
	"github.com/codervinod/intent_api/client/packet_processor_chain"
	"github.com/codervinod/intent_api/client/permission"
	"github.com/codervinod/intent_api/client/policy"
	"github.com/codervinod/intent_api/client/project"
	"github.com/codervinod/intent_api/client/role"
	"github.com/codervinod/intent_api/client/user"
	"github.com/codervinod/intent_api/client/versions"
	"github.com/codervinod/intent_api/client/vm"
	"github.com/codervinod/intent_api/client/vm_backup"
	"github.com/codervinod/intent_api/client/vm_backup_profile"
	"github.com/codervinod/intent_api/client/vm_snapshot"
	"github.com/codervinod/intent_api/client/volume_group"
	"github.com/codervinod/intent_api/client/volume_group_backup"
	"github.com/codervinod/intent_api/client/volume_group_snapshot"
	"github.com/codervinod/intent_api/client/webhook"
	"github.com/codervinod/intent_api/client/workflow"
)
